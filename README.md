...
- Teachers create reading assignments with passage text, time limits, and questions.
- Students enter an assignment code and answer inside a restricted reading session.
